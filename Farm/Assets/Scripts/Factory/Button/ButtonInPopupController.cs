...
public class ButtonInPopupController : MonoBehaviour
{
    ...
    {
        Transform childObject = transform.parent.transform.parent.FindChild(name);
        if (childObject != null)
    ...
    {
        Transform machinrInforPre = this.transform.parent.FindChild("MachineInfor");
    ...
    {
        Transform childObject = transform.parent.transform.FindChild("Sell");
        childObject.gameObject.SetActive(isVisible);
    }
    void DestroyInforMaterialProduct()
    {
        Transform materialPre = machineSelected.transform.FindChild("Material");
        if (materialPre != null)
        {
