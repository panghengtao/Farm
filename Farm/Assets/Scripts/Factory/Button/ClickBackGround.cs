...
public class ClickBackGround : MonoBehaviour
{
    ...
    void FindAnDestroyChild(string name)
    {
        ...
        {
            Transform childObject = MachineController.machineSelect.transform.FindChild(name);
            if (childObject != null)
    ...
    {
        Transform childObject = UIRoot.FindChild(name);
        if (childObject != null)
            Destroy(childObject.gameObject);
    }
    void LoadBtView()
    ...
    void ControllMouseUpLock()
    {
        ...
        Transform panelComfirm = UIRoot.transform.FindChild("PanelComfirmUnlock");
    ...
    {
        Transform lockPre = this.gameObject.transform.FindChild("Lock");
        if (lockPre != null)
