...
public class DialogTask : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        lbStar2 = transform.FindChild("LbStar2").GetComponent<UILabel>();
        lbStar3 = transform.FindChild("LbStar3").GetComponent<UILabel>();
        star1 = transform.FindChild("Star1").GetComponent<UITexture>();
        star1.gameObject.SetActive(false);
        star2 = transform.FindChild("Star2").GetComponent<UITexture>();
        star2.gameObject.SetActive(false);
        star3 = transform.FindChild("Star3").GetComponent<UITexture>();
        star3.gameObject.SetActive(false);

        grid = transform.FindChild("Grid").GetComponent<UIGrid>();
        tip = transform.FindChild("Tip").GetComponent<UILabel>();
        bgColider = transform.FindChild("BgColider");
        bgColider.gameObject.SetActive(false);
        Spriterblack = transform.FindChild("Spriterblack");
