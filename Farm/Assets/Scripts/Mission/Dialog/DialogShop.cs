...
public class DialogShop : DialogAbs
{
    ...
    void Awake()
    {
        ...
        gridView = main.FindChild("Scroll View").FindChild("Grid");
        //gridView.gameObject.SetActive(false);
        lbDesciption = main.FindChild("Description").GetComponent<UILabel>();
        lbPrice = main.FindChild("Buy").FindChild("Price").GetComponent<UILabel>();
        lbIconName = main.FindChild("BgRight").FindChild("Name").GetComponent<UILabel>();
        btBuy = main.FindChild("Buy");
    ...
    {
        Transform old = main.FindChild("BgRight").FindChild("Icon").FindChild("IconItem");
        if (old != null)
        {
        ...
        icon.parent = main.FindChild("BgRight").FindChild("Icon");
        icon.name = "IconItem";
    ...
    public override void HideDialog(DialogAbs.CallBackHideDialog callback = null)
    {
        ...
        {
            transform.parent.FindChild("DialogMission").gameObject.SetActive(true);
            main.gameObject.SetActive(false);
            main.FindChild("Scroll View").gameObject.SetActive(false);
