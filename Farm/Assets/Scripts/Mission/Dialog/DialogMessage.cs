...
public class DialogMessage : DialogAbs
{
    ...
    {
        isInbox = true;
        lbInbox = transform.FindChild("StateInbox").GetComponent<UILabel>();
        lbInbox.gameObject.SetActive(true);
        gridViewReceive = transform.FindChild("ScrollView").FindChild("GridReceive");
        gridViewRequest = transform.FindChild("ScrollView").FindChild("GridRequest");
        dialogLoading = transform.parent.FindChild("DialogLoading");
        gridViewRequest.gameObject.SetActive(false);
        gameObject.SetActive(false);
        transform.FindChild("TabReceiveOff").gameObject.SetActive(false);
        transform.FindChild("TabRequestOff").gameObject.SetActive(true);
    }
    ...
    public void ReceiveButton()
    {
        ...
        transform.FindChild("TabReceiveOff").gameObject.SetActive(false);
        transform.FindChild("TabReceiveOn").gameObject.SetActive(true);
        transform.FindChild("TabRequestOff").gameObject.SetActive(true);
        transform.FindChild("TabRequestOn").gameObject.SetActive(false);
    ...
    public void RequestButton()
    {
        ...
        transform.FindChild("TabReceiveOff").gameObject.SetActive(true);
        transform.FindChild("TabReceiveOn").gameObject.SetActive(false);
        transform.FindChild("TabRequestOff").gameObject.SetActive(false);
        transform.FindChild("TabRequestOn").gameObject.SetActive(true);
