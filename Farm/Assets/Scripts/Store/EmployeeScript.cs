...
public class EmployeeScript : MonoBehaviour
{
    ...
    void LateUpdate()
    {
                ...
                if (shopcenter.staffDatas[i].typeStaff != 0)
                {
                    ...
                    else
                    {
                        ...
                        if (!(shopcenter.indexTraining != i || shopcenter.countTimeTraining != 0))
                        {
                            ...
                            tempTransform = staffObjects[i].transform.FindChild(tempName);
        ...
        if (Input.GetKeyDown(KeyCode.Escape) || CommonObjectScript.isEndGame || CommonObjectScript.isViewComplete)
        {
            ...
            {
                indexPopupConfirm = -1;
                transform.FindChild("PopupConfirm").gameObject.SetActive(false);
    ...
    public void FireStaff()
    {
        ...
        transform.FindChild("PopupConfirm").gameObject.SetActive(true);
        indexPopupOpen = -1;
    ...
    public void Popup_Fire(GameObject btn)//confirm fire
    {
        if (btn.gameObject.name.Equals("Btn_Ok"))
        {
            ...
            GameObject.Destroy(staffObjects[indexPopupConfirm].transform.FindChild(shopcenter.staffDatas[indexPopupConfirm].getName() + (shopcenter.staffDatas[indexPopupConfirm].levelStaff - 1).ToString()).gameObject);
