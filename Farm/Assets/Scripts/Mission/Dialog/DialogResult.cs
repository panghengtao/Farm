...
public class DialogResult : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        dialogLoadingScene = transform.parent.FindChild("LoadingScene");
        ...
        particleWin = transform.FindChild("Particle");

        star1 = bgMain.FindChild("Star1");
        star2 = bgMain.FindChild("Star2");
        star3 = bgMain.FindChild("Star3");
        star1.gameObject.SetActive(false);
        star2.gameObject.SetActive(false);
        star3.gameObject.SetActive(false);
        lbTitle = bgMain.FindChild("Title").GetComponent<UILabel>();
        lbReward = bgMain.FindChild("Reward").FindChild("Label").GetComponent<UILabel>();
        lbRewardCustomer = bgMain.FindChild("RewardCustomer").FindChild("Label").GetComponent<UILabel>();
        grid = bgMain.FindChild("Grid").GetComponent<UIGrid>();
        missionFail = bgMain.FindChild("MissionFail");
    ...
    public void AddItemResult(string content, bool finishValue, ItemAbstract itemAbstract, bool typeShow1)
    {
        ...
        item.FindChild("Checkbox").GetComponent<UIToggle>().value = finishValue;
    }
