...
public class ItemSelectFriend : MonoBehaviour
{
    ...
    void Awake()
    {
        bg = transform.FindChild("Background");
        khungavata = transform.FindChild("KhungAvatar");
        avata = transform.FindChild("Avatar");
        name = transform.FindChild("Name");
        checkBg = transform.FindChild("Checkbox").FindChild("Background");
        checkMark = transform.FindChild("Checkbox").FindChild("Checkmark");
    }
